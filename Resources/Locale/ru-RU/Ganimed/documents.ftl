...
document-text-chemical-order =
    NT-MED-CHM
    ST-ХХ-ХХХ
    ЗАКАЗ НА ПРОИЗВОДСТВО ХИМИКАТОВ

    Заявитель:
    Должность:
    Требуемое вещество:
    Необходимое количество:
    Форма выпуска: (таблетки с указанием дозировки/бутылки)
    Причина:
...
document-text-euthanasia-request =
    NT-MED-EUR
    ST-XX-XXX
    ЗАЯВЛЕНИЕ НА ПРОВЕДЕНИЕ ЭВТАНАЗИИ

    Я, (Имя Фамилия), в должности (Указать должность) в связи (Указать причину), прошу провести для себя процедуру эвтаназии. С последствиями данного решения ознакомлен, лекцию от главного врача прослушал. По окончании процедуры мое тело прошу (кремировать/переработать/космировать).
...
document-text-epicrisis=
    ...
    Диагноз при поступлении: Окончательный диагноз:
    Оказанное лечение:
    Исход лечения:
