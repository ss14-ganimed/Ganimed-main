...
ent-EncryptionKeySyndie = красный ключ шифрования
...
ent-EncryptionKeyFleet = флотский ключ шифрования
    .desc = Ключ шифрования, используемый Флотом НаноТразен.
ent-EncryptionKeyDeadSquad = пепельно-черный ключ шифрования
