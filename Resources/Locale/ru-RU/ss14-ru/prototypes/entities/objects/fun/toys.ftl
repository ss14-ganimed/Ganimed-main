...
ent-PlushieHampter = плюшевый хомяк
    .desc = Милая плюшевая игрушка, напоминающая хомяка. Он выглядит помятым.
ent-PlasticBanana = банан
    .desc = Пластиковый банан.
ent-ToyHammer = резиновый молоток
	.desc = Ярко окрашенный молот, сделанный из резины.
ent-WhoopieCushion = подушка-пердушка
	.desc = Практичный инструмент для шуток на туалетную тему.