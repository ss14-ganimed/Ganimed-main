...
ent-ClothingHandsGlovesKravMaga = перчатки Крав Мага
    .desc = Эти перчатки позволяют их владельцам овладеть стилем боя Крав Маги. Они позволяют сбивать с ног, а также ударять по легким и горлу противника, нанося сокрушающие удары.
